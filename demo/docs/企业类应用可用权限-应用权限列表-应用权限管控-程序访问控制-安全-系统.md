---
title: "企业类应用可用权限-应用权限列表-应用权限管控-程序访问控制-安全-系统"
source: "https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/permissions-for-enterprise-apps"
author:
published:
created: 2026-06-25
description: "企业类应用可用权限 以下权限面向企业类应用开放。 企业类应用包括企业普通应用和MDM（Mobile Device Management）设备管理应用。 企业类应用有以下特征： 仅在企业定制设备上运……欲了解更多信息欢迎访问华为HarmonyOS开发者官网"
tags:
  - "clippings"
---
以下权限面向企业类应用开放。

...
$base = '/data/app/el2/100/base/com.brewdsh.app/haps/entry/files'
...
& $hdc -t $T shell "aa force-stop com.brewdsh.app" 2>&1 | Out-Null
Start-Sleep -Seconds 3
$sw = [Diagnostics.Stopwatch]::StartNew()
& $hdc -t $T shell "aa start -a EntryAbility -b com.brewdsh.app" 2>&1 | Out-Null
$urlAt = $null
for ($i = 0; $i -lt 300; $i++) {

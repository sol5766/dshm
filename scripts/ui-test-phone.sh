...
timeout 15 "$HDC" -t "$TARGET" shell aa force-stop com.brewdsh.app 2>/dev/null
timeout 15 "$HDC" -t "$TARGET" shell aa start -a EntryAbility -b com.brewdsh.app -m entry 2>&1 | tail -1
...
GF="$(timeout 15 "$HDC" -t "$TARGET" shell "cat /data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/@deepseek-ai/dsh-tool-fs-search/lib/index.js 2>/dev/null | grep -c 'Buffer.isBuffer(stdout)'" | tr -d '\r')" 2>/dev/null
GE="$(timeout 15 "$HDC" -t "$TARGET" shell "cat /data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/@deepseek-ai/dsh-tool-fs-search/lib/index.js 2>/dev/null | grep -F -c 'args.push(\"-rn\", \"-E\", \"-e\", pattern, root)'" | tr -d '\r')" 2>/dev/null
...
TBF="/data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/@deepseek-ai/dsh-terminal-bash/lib/index.js"
...
BLF="/data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/@deepseek-ai/dsh-bash-local/lib/index.js"
...
MPF="/data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/dshmarket/lib/index.js"
MPCF="/data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/dshmarket/cordis.patch.yml"
MCLI="/data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/dshmarket/lib/dsh-cli.js"
MWORKER="/data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/dshmarket/lib/dshm-dsh-plugin-worker.cjs"
MPLUGIN="/data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/@deepseek-ai/dsh/lib/plugin-9h8shc4d.js"
MBF="/data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/@deepseek-ai/dsh-app-boot/lib/index.js"
MLF="/data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/@dsh-market/plugin"
CEF="/data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/dshm-config-editor/lib/index.js"
CEC="/data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/dshm-config-editor/client/client.js"
MNF="/data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/@dsh-external/dsh-mobile-nav/lib/index.js"
MNC="/data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/@dsh-external/dsh-mobile-nav/lib/client.js"
MARKET_PACKAGE="$(timeout 15 "$HDC" -t "$TARGET" shell "test -f $MPF && test -f $MPCF && test -f $MCLI && test -f $MWORKER && test -f $MPLUGIN && grep -F -q '\"pnpm\": \"10.6.3\"' /data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/@deepseek-ai/dsh/package.json && grep -F -q '\"@earendil-works/pi-ai\": \"0.82.1\"' /data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/@deepseek-ai/dsh/package.json && grep -F -q 'DSHM 鸿蒙适配：pnpm Worker 临时目录' $MPLUGIN && grep -F -q 'os.tmpdir = () => tempDir' $MPLUGIN && grep -F -q 'const bundledPnpmCli = join(process.cwd(), \"dsh\", \"node_modules\", \"pnpm\", \"dist\", \"pnpm.cjs\")' $MPLUGIN && grep -F -q 'DSHM 鸿蒙适配：dshmarket Worker CLI bridge v11' $MCLI && grep -F -q 'new Worker(workerPath, { workerData: { bin: dshBin, args }, stdout: true, stderr: true })' $MCLI && printf 1" | tr -d '\r')"
...
BUILTIN_MOBILE="$(timeout 15 "$HDC" -t "$TARGET" shell "test -f $MNF && test -f $MNC && grep -F -q 'name\": \"@dsh-external/dsh-mobile-nav\"' /data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/@dsh-external/dsh-mobile-nav/package.json && grep -F -q 'data-mobile-nav=\"frame\"' $MNC && printf 1" | tr -d '\r')"
MARKET_MIGRATION="$(timeout 15 "$HDC" -t "$TARGET" shell "grep -F -c 'DSHM profile-managed market seed v2' $MBF && grep -F -q 'function seedProfilePackageClosure' $MBF && grep -F -q 'dependencyClosureVersion !== 2' $MBF && grep -F -q 'const profileManaged = packageName === \"dshmarket\" || packageName === \"@dsh-external/dsh-mobile-nav\"' $MBF && grep -F -q '\"dshm-config-editor\": \"1.0.0\"' /data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/@deepseek-ai/dsh/package.json && grep -F -q '\"@dsh-external/dsh-mobile-nav\": \"1.0.0\"' /data/app/el2/100/base/com.brewdsh.app/haps/entry/files/dsh/node_modules/@deepseek-ai/dsh/package.json && test ! -e $MLF" | tr -d '\r')"
